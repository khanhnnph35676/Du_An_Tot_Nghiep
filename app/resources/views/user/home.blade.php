                                            ...
                                            <form action="{{ route('addToCart') }}" method="POST">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    ...
                                                    <p class="text-start text-dark fs-6 fw-bold">
                                                        {{ Str::words(strip_tags($product->name), 6, '...') }}</p>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        @else
                                                            ...
                                                            <del class="fs-6 ms-2">
                                                                {{ number_format($product->price) }}Vnđ</del>
                                                        @endif
                                                    </div>
                                                    <br>
                                                    <input type="text" id="stockInput{{ $product->id }}"
                                                        name="stock" value="0" hidden>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6">
                                ...
                                <form action="{{ route('addToCart') }}" method="POST"
                                    ...
                                    <p class="mb-3 fs-6 text-secondary fw-bold" id="product-price">
                                        {{ number_format($product->price, 2) }} Vnđ</p>
