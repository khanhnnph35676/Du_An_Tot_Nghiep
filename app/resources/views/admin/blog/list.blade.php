...
@section('content')
    ...
    <div class="content-body">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <button class="btn btn-primary" data-toggle="modal" data-target="#addPostModal">Thêm Blog
                                    mới</button>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('/storage/images/blog/' . $blog->BlogImage) }}"
                                                    ...
                                                    style="width: auto; height: 100px; object-fit: cover;" alt="image">
                                                {{ $blog->BlogTitle }}
                                            </td>
                                            ...
                                            <td> {{ $blog->blog_categories->blog_categories_name}}</td>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-danger" data-toggle="modal"
                                                    data-target="#deleteModal{{ $blog->idBlog }}">Xóa</button>

                                            </td>
                                        </tr>

                                        <div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog"
                                            id="modal-delete-{{ $blog->idBlog }}" aria-hidden="true">
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{ URL::to('/delete-blog/' . $blog->idBlog) }}"
        ...
        @foreach ($list_blog as $blog)
            <div class="modal fade" id="deleteModal{{ $blog->idBlog }}" tabindex="-1" role="dialog"
                aria-labelledby="deleteModalLabel{{ $blog->idBlog }}" aria-hidden="true">
                <div class="modal-dialog " role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="deleteModalLabel{{ $blog->idBlog }}">Xóa Blog:
                                {{ $blog->BlogTitle }}</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
