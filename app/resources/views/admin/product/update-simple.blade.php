...
@section('content')
    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.updateProductSimple', $product->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @method('patch')
                        @csrf
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Cập nhật sản phẩm đơn thể</h4>
                                <div class="d-flex">
                                    ...
                                    <div class="col-8 p-3 mr-4  ml-4 border">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="qty"
                                                value="{{ $product->qty }}" placeholder="Số lượng">
                                            @error('qty')
                                                <div class="alert alert-danger"><strong>Lỗi!</strong> {{ $message }}
                                                </div>
                                            @enderror
