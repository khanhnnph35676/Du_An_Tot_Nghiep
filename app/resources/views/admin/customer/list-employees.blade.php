            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        ...
                        <span class="ml-1">Danh sách nhân viên</span>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="">Trang chủ</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Danh sách nhân viên</a></li>
                    </ol>
                </div>
            </div>
            @if (session('message'))
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <form action="{{ route('admin.customerDestroy', $user->id) }}"
                                                            method="POST"
                                                            onsubmit="return confirm('Bạn có muốn xoá tài khoản này không?');">
                                                            @csrf
                                                            @method('DELETE')
